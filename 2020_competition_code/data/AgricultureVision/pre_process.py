...
DATASET_ROOT = '<YOUR IMAGES 2021 ROOT>'

TRAIN_ROOT = os.path.join(DATASET_ROOT, 'train')
VAL_ROOT = os.path.join(DATASET_ROOT, 'val')
TEST_ROOT = os.path.join(DATASET_ROOT, 'test') #### Need to redo for test loader
