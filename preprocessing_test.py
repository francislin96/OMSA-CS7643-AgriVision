...
boundary_path = './data/images_2024/raw_tif_files/17YHKHGGQ Wu Jing/boundary.json'

# print(os.path.exists(boundary_path))
img_dir = './data/images_2024/raw_tif_files/17YHKHGGQ Wu Jing/imagery'
