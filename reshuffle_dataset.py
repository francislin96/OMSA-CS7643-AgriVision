...
subfolders = ['boundaries','images\\nir','images\\rgb','labels\\double_plant','labels\\drydown',
              'labels\\endrow','labels\\nutrient_deficiency','labels\\planter_skip','labels\\storm_damage',
